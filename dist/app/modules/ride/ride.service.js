...
const cancelRequest = (riderId, rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (rideInfo.status == ride_interface_1.RideStatus.requested) {
      ...
      const updateStatus = yield ride_model_1.Ride.findByIdAndUpdate(
        rideId,
        {
          $set: updateObject,
      ...
      throw new AppError_1.default(
        http_status_codes_1.default.NOT_FOUND,
        "allow only request rides."
      );
    }
  });
// driver control
const acceptsRequest = (driverId, rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const picked_upRequest = (driverId, rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const driver = yield user_model_1.default.findById(driverId);
    if (!driver) {
      throw new AppError_1.default(
    ...
    if (rideInfo.status == ride_interface_1.RideStatus.accepted) {
      ...
      throw new AppError_1.default(
        http_status_codes_1.default.NOT_FOUND,
        "allow only accepted rides."
      );
    }
  });
const in_transitRequest = (driverId, rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const driver = yield user_model_1.default.findById(driverId);
    if (!driver) {
      throw new AppError_1.default(
    ...
    if (rideInfo.status == ride_interface_1.RideStatus.picked_up) {
      ...
      throw new AppError_1.default(
        http_status_codes_1.default.NOT_FOUND,
        "allow only picked_up rides."
      );
    }
  });
const completedRequest = (driverId, rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const driver = yield user_model_1.default.findById(driverId);
    if (!driver) {
      throw new AppError_1.default(
    ...
    if (rideInfo.status == ride_interface_1.RideStatus.in_transit) {
      ...
      throw new AppError_1.default(
        http_status_codes_1.default.NOT_FOUND,
        "allow only in_transit rides."
      );
    }
  });
const paidRequest = (driverId, rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const driver = yield user_model_1.default.findById(driverId);
    if (!driver) {
      throw new AppError_1.default(
    ...
    if (rideInfo.status == ride_interface_1.RideStatus.completed) {
      ...
      let totalEarnings = 0;
      const fare = (0, fareCalculator_1.calculateFare)(
...
const findNearbyDrivers = (rideId) =>
  __awaiter(void 0, void 0, void 0, function* () {
